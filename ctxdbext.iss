...
AppVerName=Context Database Extensions v.2.07
...
Source: "lib\d6\*.*"; DestDir: "{app}\libd6"; Flags: ignoreversion; Components: libd6
...
Source: "lib\d7\*.*"; DestDir: "{app}\libd7"; Flags: ignoreversion; Components: libd7
...
Source: "lib\d2005\*.*"; DestDir: "{app}\libd2005"; Flags: ignoreversion; Components: libd2005
...
Source: "lib\d2006\*.*"; DestDir: "{app}\libd2006"; Flags: ignoreversion; Components: libd2006
