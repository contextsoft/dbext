...
AppVerName=Context Database Extensions v.3.01
...
;Filename: "{app}\help\instlhlp.exe"; Parameters: "-UH CtxDBExtHelp ctxdbext.hlp bds 4.0 d2006"; StatusMsg: "Removing Help (Delphi 2007)..."; Check: DoInstHelp('libd2007')
