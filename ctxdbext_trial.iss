...
AppVerName=Context Database Extensions v.3.01 Trial
AppCopyright=Copyright © 2003-2007, Michael Baytalsky
...
[Components]
Name: "libd5"; Description: "Delphi 5 Library"; Types: Default
Name: "libd6"; Description: "Delphi 6 Library"; Types: Default
...
Name: "libcb6"; Description: "C++Builder 6 Library"; Types: Default
Name: "libc2006"; Description: "C++Builder 2006/BDS 4.0 Library"; Types: Default
...
Source: "lib\d5\*.*"; DestDir: "{app}\libd5"; Flags: ignoreversion; Components: libd5
Source: "source\*.*"; Excludes: "*.pas"; DestDir: "{app}\libd5"; Flags: recursesubdirs ignoreversion; Components: libd5

Source: "lib\d6\*.*"; Excludes: "CtxGridView.*,CtxProfiles.*,CtxPropView.*"; DestDir: "{app}\libd6"; Flags: ignoreversion; Components: libd6
Source: "source\*.*"; Excludes: "*.pas"; DestDir: "{app}\libd6"; Flags: recursesubdirs ignoreversion; Components: libd6
...
Source: "lib\cb6\*.*"; Excludes: "CtxGridView.*,CtxProfiles.*,CtxPropView.*"; DestDir: "{app}\libcb6"; Flags: ignoreversion; Components: libcb6
Source: "source\*.*"; Excludes: "*.pas"; DestDir: "{app}\libcb6"; Flags: recursesubdirs ignoreversion; Components: libcb6
...
Root: HKCU; Subkey: "Software\Borland\BDS\4.0\Known Packages"; ValueType: string; ValueData: "Context Database Extensions"; ValueName: "{app}\libc2006\DBExtPkgC2006.bpl"; Flags: uninsdeletevalue; Components: libc2006
Root: HKCU; Subkey: "Software\Borland\C++Builder\6.0\Known Packages"; ValueType: string; ValueData: "Context Database Extensions"; ValueName: "{app}\libcb6\DBExtPkgCB6.bpl"; Flags: uninsdeletevalue; Components: libcb6
...
Filename: "{app}\help\instlhlp.exe"; Parameters: "-IP bds 4.0 libd2006 source"; StatusMsg: "Adding library paths (Delphi 2006)..."; Components: libd2006
Filename: "{app}\help\instlhlp.exe"; Parameters: "-IP C++Builder 6.0 libcb6 source"; StatusMsg: "Adding library paths (C++Builder 6)..."; Components: libcb6
Filename: "{app}\help\instlhlp.exe"; Parameters: "-IP bds 4.0 libc2006 source cpp"; StatusMsg: "Adding library paths (C++Builder 2006)..."; Components: libc2006
Filename: "{app}\help\instlhlp.exe"; Parameters: "-IP bds 5.0 libd2007 source"; StatusMsg: "Adding library paths (Delphi 2007)..."; Components: libd2007
...
Filename: "{app}\help\instlhlp.exe"; Parameters: "-IH CtxDBExtHelp ctxdbext.hlp C++Builder 6.0 bcb6"; StatusMsg: "Installing Help (C++Builder 6)..."; Check: DoInstHelp('libcb6')
;Filename: "{app}\help\instlhlp.exe"; Parameters: "-IH CtxDBExtHelp ctxdbext.hlp bds 5.0 d2007"; StatusMsg: "Installing Help (Delphi 2007)..."; Check: DoInstHelp('libd2007')
...
Filename: "{app}\help\instlhlp.exe"; Parameters: "-UP bds 4.0 libd2006 source"; StatusMsg: "Removing library paths (Delphi 2006)..."; Components: libd2006
Filename: "{app}\help\instlhlp.exe"; Parameters: "-UP C++Builder 6.0 libcb6 source"; StatusMsg: "Removing library paths (C++Builder 6)..."; Components: libcb6
Filename: "{app}\help\instlhlp.exe"; Parameters: "-UP bds 4.0 libc2006 source cpp"; StatusMsg: "Removing library paths (C++Builder 2006)..."; Components: libc2006
Filename: "{app}\help\instlhlp.exe"; Parameters: "-UP bds 5.0 libd2007 source"; StatusMsg: "Removing library paths (Delphi 2007)..."; Components: libd2007
...
Filename: "{app}\help\instlhlp.exe"; Parameters: "-UH CtxDBExtHelp ctxdbext.hlp C++Builder 6.0 bcb6"; StatusMsg: "Removing Help (BCB 6)..."; Check: DoInstHelp('libcb6')
;Filename: "{app}\help\instlhlp.exe"; Parameters: "-UH CtxDBExtHelp ctxdbext.hlp bds 5.0 d2007"; StatusMsg: "Removing Help (Delphi 2007)..."; Check: DoInstHelp('libd2007')
