...
AppVerName=Context Database Extensions v.3.40 Trial
AppCopyright=Copyright © 2003-2016, Michael Baytalsky
...
Source: "lib\dXE3\*.*"; Excludes: "CtxGridView.*,CtxProfiles.*,CtxPropView.*"; DestDir: "{app}\libdXE3"; Flags: ignoreversion; Components: libdXE3
Source: "source\*.*"; Excludes: "*.pas"; DestDir: "{app}\libdXE3"; Flags: recursesubdirs ignoreversion; Components: libdXE3

Source: "lib\dXE4\*.*"; Excludes: "CtxGridView.*,CtxProfiles.*,CtxPropView.*"; DestDir: "{app}\libdXE4"; Flags: ignoreversion; Components: libdXE4
Source: "source\*.*"; Excludes: "*.pas"; DestDir: "{app}\libdXE4"; Flags: recursesubdirs ignoreversion; Components: libdXE4

Source: "lib\dXE5\*.*"; Excludes: "CtxGridView.*,CtxProfiles.*,CtxPropView.*"; DestDir: "{app}\libdXE5"; Flags: ignoreversion; Components: libdXE5
Source: "source\*.*"; Excludes: "*.pas"; DestDir: "{app}\libdXE5"; Flags: recursesubdirs ignoreversion; Components: libdXE5

Source: "lib\dXE6\*.*"; Excludes: "CtxGridView.*,CtxProfiles.*,CtxPropView.*"; DestDir: "{app}\libdXE6"; Flags: ignoreversion; Components: libdXE6
Source: "source\*.*"; Excludes: "*.pas"; DestDir: "{app}\libdXE6"; Flags: recursesubdirs ignoreversion; Components: libdXE6

Source: "lib\dXE7\*.*"; Excludes: "CtxGridView.*,CtxProfiles.*,CtxPropView.*"; DestDir: "{app}\libdXE7"; Flags: ignoreversion; Components: libdXE7
Source: "source\*.*"; Excludes: "*.pas"; DestDir: "{app}\libdXE7"; Flags: recursesubdirs ignoreversion; Components: libdXE7

Source: "lib\dXE8\*.*"; Excludes: "CtxGridView.*,CtxProfiles.*,CtxPropView.*"; DestDir: "{app}\libdXE8"; Flags: ignoreversion; Components: libdXE8
Source: "source\*.*"; Excludes: "*.pas"; DestDir: "{app}\libdXE8"; Flags: recursesubdirs ignoreversion; Components: libdXE8

Source: "lib\d10\*.*"; Excludes: "CtxGridView.*,CtxProfiles.*,CtxPropView.*"; DestDir: "{app}\libd10"; Flags: ignoreversion; Components: libd10
...
Root: HKCU; Subkey: "Software\Embarcadero\BDS\18.0\Known Packages"; ValueType: string; ValueData: "Context Database Extensions"; ValueName: "{app}\libd10\DBExtPkgD101.bpl"; Flags: uninsdeletevalue; Components: libd101
