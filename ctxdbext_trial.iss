...
AppVerName=Context Database Extensions v.3.31 Trial
...
Filename: "{app}\help\instlhlp.exe"; Parameters: "-UP embarcadero\bds 10.0 libdXE2 source cpp"; StatusMsg: "Adding library paths (Delphi XE3)..."; Components: libdXE3
